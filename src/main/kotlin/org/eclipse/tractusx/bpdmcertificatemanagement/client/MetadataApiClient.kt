...
interface MetadataApiClient: MetadataApi {

    @PostExchange("/certificate-types")
    override fun setCertificateType(@Valid @RequestBody certificateTypeDto: CertificateTypeDto): CertificateTypeDto

    @GetExchange("/certificate-types")
    override fun getCertificateTypes(@ParameterObject paginationRequest: PaginationRequest): PageDto<CertificateTypeDto>
}