...
class CertificateClientImpl(
...
) : CertificateManagementApiClient {
    ...
    override val certificateApi by lazy { createClient<CertificateApiClient>() }

    override val metadataApi by lazy { createClient<MetadataApiClient>() }
